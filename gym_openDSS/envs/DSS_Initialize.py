"""
In this file I specify the sectionalizing and tie switch details. Also the path for the DSS file containing 
the circuit information is specified. We create the final DSS circuit which will be used by the environment.
"""
